...
#+BEGIN_SRC emacs-lisp :var title=(read-string "title: ")
  (setq id (format "%d;%s" (length (org-map-entries t "LEVEL=2" nil)) title))
  (org-insert-heading)
  (insert (concat "#" id))
  (org-metaright)
  (org-todo "DRAFT")
  (org-set-property "export_file_name" (replace-regexp-in-string " " "-" (downcase id)))
  (next-line)
  (insert "\n")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :var url=(getenv "BLOG_BASE") :var title=(read-string "title: ")
  (setq id (format "%d;%s" (length (org-map-entries t "LEVEL=2" nil)) title))
  (setq nId (replace-regexp-in-string " " "-" (downcase id)))
  (org-insert-heading)
  (insert (concat "#" id))
  (org-metaright)
  (org-todo "TODO")
  (org-insert-structure-template "description")
  (org-set-property "export_file_name" nId)
  (next-line)
  (insert "\n")
  ;; Begin meta table
  (org-insert-heading)
...
:export_hugo_custom_front_matter+: :milestone "micro"
...
** DONE #7;match-array :typescript:
CLOSED: [2022-04-26 Di 12:33]
:PROPERTIES:
:export_file_name: 7;match-array
:END:
...
:export_hugo_custom_front_matter+: :milestone "blog"
:export_hugo_custom_front_matter+: :timestamp ((lambda (ts) (let* ((d (date-to-time (if ts ts (format-time-string (org-time-stamp-format t))))) (f (pop d)) (s (pop d))) (* (+ (* f (math-pow 2 16)) s) 1000))) (org-entry-get (point) "CLOSED"))
:export_hugo_custom_front_matter+: :state (if (org-entry-get (point) "CLOSED") "CLOSED" "OPEN")
:END:
#+CALL: post()
** TODO #6;Proxis in fantasyland :typescript:
:PROPERTIES:
:export_file_name: 6;proxies-in-fantasyland
:END:
#+begin_description
...
| Asset                                  | Description   |
|----------------------------------------+---------------|
| https://ja.nz/6;proxies-in-fantasyland | Location      |
