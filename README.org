...
:END:
#+FILETAGS: :typescript:go:zig:c:nix:structures:diff:css:
...
- [[#short][Short]]
  ...
  - [[#9utility-flatten-nested-types][9,Utility: Flatten nested types]]
- [[#long][Long]]
...
** DONE 9,Utility: Flatten nested types :typescript:
...
This one does not work properly as it will export to
a code block but without any formattings. There is kinda no point to use it.
#+begin_example
